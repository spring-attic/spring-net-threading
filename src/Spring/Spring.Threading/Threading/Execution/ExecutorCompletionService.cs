...
namespace Spring.Threading.Execution
{
	...
	public class ExecutorCompletionService : ICompletionService
	{
		...
		private IBlockingQueue _completionQueue;
		...
		/// <see cref="Spring.Threading.Collections.LinkedBlockingQueue"/> as a completion queue.
		/// </summary>
		...
		public ExecutorCompletionService(IExecutor executor) : this( executor, new LinkedBlockingQueue())
		{
		}
		...
		{
			return (IFuture) _completionQueue.Poll();
		}
		/// <summary> 
		/// Retrieves and removes the <see cref="Spring.Threading.Future.IFuture"/> representing the next
		...
		{
			return (IFuture) _completionQueue.Poll(durationToWait);
		}
