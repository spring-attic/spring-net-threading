...
//        public ScheduledThreadPoolExecutor( int corePoolSize ) : base(corePoolSize, Int32.MaxValue, new TimeSpan(0), new DelayQueue())
//        {
...
//        public ScheduledThreadPoolExecutor(int corePoolSize, IThreadFactory threadFactory): base(corePoolSize, Int32.MaxValue, new TimeSpan(0), new DelayQueue(), threadFactory )
//        {
...
//        /// <exception cref="IFuture">if the command is null</exception>
//        public override IList<IFuture<T>> InvokeAll<T>(ICollection<T> tasks)
//        {
//            throw new NotImplementedException();
//        }
...
//        /// <exception cref="IFuture.IsDone">if the task cannot be accepted for execution.</exception>
//        /// <exception cref="IFuture">if the command is null</exception>
//        public override IList<IFuture<T>> InvokeAll<T>(ICollection<T> tasks, TimeSpan durationToWait)
//        {
//            throw new NotImplementedException();
//        }
...
//        /// upon completion.
//        /// </returns>
//        public IScheduledFuture<T> Schedule<T>(IRunnable command, TimeSpan delay)
//        {
//            throw new NotImplementedException();
//        }
...
//        /// cancellation.
//        /// </returns>
//        public IScheduledFuture<T> ScheduleAtFixedRate<T>(IRunnable command, TimeSpan initialDelay, TimeSpan period)
//        {
//            throw new NotImplementedException();
//        }
...
//        /// cancellation.
//        /// </returns>
//        public IScheduledFuture<T> ScheduleWithFixedDelay<T>(IRunnable command, TimeSpan initialDelay, TimeSpan delay)
//        {
//            throw new NotImplementedException();
//        }
...
//        /// <exception cref="System.ArgumentNullException">if the command is null</exception>
//        public override T InvokeAny<T>(ICollection<T> tasks, TimeSpan durationToWait)
//        {
//            throw new NotImplementedException();
//        }
