...
//    /// complete.  A <see cref="Spring.Threading.Execution.ICompletionService{T}"/> can for example be used to
...
//    /// <p/>
//    /// 
//    /// Typically, a <see cref="Spring.Threading.Execution.ICompletionService{T}"/> relies on a separate 
//    /// <see cref="Spring.Threading.IExecutor"/> to actually execute the tasks, in which case the
//    /// <see cref="Spring.Threading.Execution.ICompletionService{T}"/> only manages an internal completion
//    /// queue. The {@link ExecutorCompletionService} class provides an
//    /// <seealso cref="Spring.Threading.Execution.ExecutorCompletionService{T}"/>
//    /// </remarks>
