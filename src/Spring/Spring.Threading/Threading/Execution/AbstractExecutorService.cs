...
namespace Spring.Threading.Execution
{
	...
	public abstract class AbstractExecutorService : IExecutorService
	{
		...
		public abstract IList ShutdownNow();
		/// <summary> 
		...
		public virtual Object InvokeAny(ICollection tasks)
		{
			try
			{
				return doInvokeAny(tasks, false, new TimeSpan(0));
			}
		...
		public virtual IList InvokeAll(ICollection tasks)
		{
			...
			IList futures = new ArrayList(tasks.Count);
			bool done = false;
			try
			{
		...
		private object doInvokeAny(ICollection tasks, bool timed, TimeSpan durationToWait)
		{
			if (tasks == null)
				throw new ArgumentNullException("tasks");
			...
			IList futures = new ArrayList(numberOfTasks);
