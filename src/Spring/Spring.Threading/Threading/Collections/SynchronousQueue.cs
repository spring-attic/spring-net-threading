...
namespace Spring.Threading.Collections {
    ...
    public class SynchronousQueue<T> : AbstractQueue<T>, IBlockingQueue<T> {
        ...
        */
        ...
        /// </summary>
        private abstract class WaitQueue { //}implements java.io.Serializable {
            /// <summary>
        ...
        /// </summary>
        private class FifoWaitQueue : WaitQueue { //}implements java.io.Serializable {
         ...
         */
        private class LifoWaitQueue : WaitQueue { //}implements java.io.Serializable {
