...
namespace Spring.Threading.Collections {
    ...
    /// <p/> 
    /// An <see cref="IQueue{T}"/> implementation that extends this class must
    ...
    public abstract class AbstractQueue<T> : IQueue<T> {
        ...
        /// <see cref="Spring.Threading.Collections.AbstractQueue{T}.Poll()"/> only in that
        ...
        /// <p>
        /// Attempts to
        /// <see cref="Spring.Threading.Collections.AbstractQueue{T}.AddAll(ICollection{T})"/>
        ...
        /// An exception encountered while trying to add an element may result in only some
        ...
        public virtual bool AddAll(ICollection<T> collection) {
            ...
            if(collection.Count > Capacity) {
                throw new ArgumentException("Collection size greater than queue capacity.");
            }
            bool modified = false;
        ...
        /// <summary>
        /// remove the <paramref name="item"/> from the queue
        /// </summary>
        /// <param name="item">the item to remove</param>
        /// <returns><code>true</code>it the item were removed <code>false</code> otherwise</returns>
        ...
        /// </summary>
        /// <returns> 
        /// The head of this queue, or <code>default(T)</code> if this queue is empty.
        /// <b>If the type parameter of the <see cref="AbstractQueue{T}"/> is a value type the return value
        /// of an empty queue cannot be distinguished from a valid item. In this case <see cref="IsEmpty"/>
        /// has to be used to detect whther the queue is empty</b> 
        /// </returns>
        ...
        ///</summary>
        ///<param name="array">The one-dimensional <see cref="T:System.Array"></see> that is the destination of 
        /// the elements copied from <see cref="T:System.Collections.ICollection"></see>. 
        ...
        /// <returns><code>true</code>if the queue contains <paramref name="item"/> otherwise <code>false</code></returns>
